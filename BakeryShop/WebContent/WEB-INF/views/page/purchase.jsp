...
.order-title{
	...
	<div id="wrapper" class="homepage-1">
		...
		<div class="container">
			<div class="orders">
				<h2 class="order-title">LỊCH SỬ MUA HÀNG TẠI BAKERYSHOP CỦA KHÁCH HÀNG</h2>
				<c:forEach var="o" items="${Orders}" varStatus="status">
					<div class="order">
						<div class="order-info">
							<div class="pull-left">
								<div class="info-order-left-text">
									Đơn hàng số <a class="link"> ${o.id_order}</a>
								</div>
								<p class="text info desc">
									Đặt ngày
									<fmt:formatDate pattern="dd-MM-yyyy" value=" ${o.order_date }" />${o.order_date }</p>
							</div>
							<div class="pull-cont"></div>
							<a href="page/detail_order/${o.id_order}.htm" class="pull-right link manage"
								style="color: rgb(26, 156, 183);">CHI TIẾT ĐƠN HÀNG</a>
							<div class="clear"></div>
						</div>
						<c:set var="total" value="${0}"/>
						<c:forEach var="d" items="${ o.details}" varStatus="status">
							<div class="order-item">
								<div class="item-pic" data-spm="detail_image">
									<a href="#"><img
										src="resources/page/images/${d.product.image }"></a>
								</div>
								<div class="item-main item-main-mini">
									<div>
										<div class="text title item-title">${d.product.name}</div>
										<p class="text desc"></p>
								...
								<div class="item-quantity">
									<span><span class="text desc info multiply">Số
											lượng:</span><span class="text">&nbsp;${d.quality}</span></span>
								</div>
								...
								<c:set var="total" value="${total + d.price}" />
								<div class="clear"></div>
							</div>
						...
						<div class="order-total">
							<div class="order-total-payment">
								<img src="resources/page/images/salary.svg" alt=""
									...
									số tiền: </span> <span class="total-payment">${total}</span>
							</div>
							<div class="order-btn">
								<div class="btn-buy-again">
									<a class="btn-item btn-main" href="/">Mua Lần Nữa</a>
								</div>
								<div class="btn-show-detail">
									<a class="btn-item btn-detail" href="page/detail_order/${o.id_order}.htm">Xem Chi Tiết Đơn
										Hàng</a>
								</div>
							</div>
						</div>
