			...
			<div class="dashboard">
				...
				<div class="right">
					<div class="right__content">
						...
						<p class="right__desc">Thêm Quản Trị Viên</p>
						<div class="right__formWrapper">
							<form:form action="admin/insert_admin.htm"
								modelAttribute="newAdmin" enctype="multipart/form-data" method="post">
								...
								<form:button class="btn">Thêm Quản Trị Viên</form:button>
							</form:form>
