...
img.img-responsive {
	...
	<div class="main">
		...
		<form:form class="form1" action="admin/login.htm" modelAttribute="admin" method="post">
			<form:input path="user_name" class="un " type="text" align="center"
				placeholder="Username" />
			<form:errors path="user_name" />
			<form:input path="password" class="pass" type="password"
				align="center" placeholder="Password" />
			<form:errors path="password" />
			<form:button align="center" class="submit">login</form:button>
			<span id="message.errors">${message}</span>
			<p class="forgot" align="center">
				<a href="admin/forgotPassword.htm">Forgot Password? </a>
			</p>
		</form:form>
	</div>
